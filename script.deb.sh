...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/datawireio/telepresence/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/datawireio/telepresence/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/datawireio_telepresence.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    mkdir -p "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/datawireio_telepresence-archive-keyring.gpg"
  gpg_key_path_old="/etc/apt/trusted.gpg.d/datawireio_telepresence.gpg"
